...
## 📐✏️ Architecture
The app is built with the Clean Architecture Model-View-ViewModel (MVVM) architecture with Repository pattern which is used to separate the app's user data, domain, and presentation.
...
- User opens the app and sees the main weather screen with weather details of the default city - Lahore.
