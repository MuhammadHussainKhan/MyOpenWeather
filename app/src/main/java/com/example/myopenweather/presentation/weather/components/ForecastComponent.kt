package com.example.myopenweather.presentation.weather.components
...
import com.example.myopenweather.domain.utils.DateUtil.toFormattedDay
...
fun ForecastComponent(
    ...
    ElevatedCard(
        ...
        Column(
            modifier = Modifier
                .fillMaxWidth().defaultMinSize(minWidth = 80.dp)
